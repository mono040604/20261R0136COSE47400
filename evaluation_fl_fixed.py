"""
评估脚本：LoRA + FocalLoss Fixed (neg_reg) 模型
与 evaluation.py 评估逻辑完全一致。
"""
import torch
import clip
import os
...
MODEL_PATH = "./trained_clip_lora_fl_fixed/model_best_clip+lora_fl_fixed.pt"
...
print("Loading model (LoRA + FocalLoss Fixed)...")
...
# BCE for clean cross-model comparison (FocalLoss eval loss isn't comparable)
