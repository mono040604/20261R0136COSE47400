...
parser.add_argument("--model-path", type=str, default="./trained_clip_lora_blend/model_best_clip+lora",
...
print(">>> EVAL_BLEND: evaluating model trained with blend=0.4 (Specialized + Visual)")
...
# ==========================================
TRAINING_BLEND = 0.4  # ← BLEND MODEL: trained with 60% specialized + 40% visual
