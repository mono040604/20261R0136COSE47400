...
parser.add_argument("--model-path", type=str, default="./trained_clip_lora_spec/model_best_clip+lora",
...
print(">>> EVAL_SPEC: evaluating model trained with blend=0.0 (Specialized Prompt)")
...
# ==========================================
TRAINING_BLEND = 0.0  # ← SPEC MODEL: trained with specialized prompt only
